...
CREATE TABLE public.facility_other (
    ...
    -- データの妥当性チェック
    CONSTRAINT chk_other_data_not_empty CHECK (jsonb_typeof(data) = 'object' AND data != '{}'::jsonb)
);
...
CREATE INDEX idx_facility_other_data_gin ON public.facility_other USING gin(data);
...
COMMENT ON COLUMN public.facility_other.data IS 'その他の情報を含む JSONB データ';
