...
CREATE TABLE public.facility_access (
    ...
    -- データの妥当性チェック
    CONSTRAINT chk_access_data_not_empty CHECK (jsonb_typeof(data) = 'object' AND data != '{}'::jsonb)
);
...
COMMENT ON COLUMN public.facility_access.data IS 'アクセス情報と地域連携情報を含む JSONB データ';
