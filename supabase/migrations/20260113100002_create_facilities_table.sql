...
-- - 後続のスキーマ変更も統合済み（phone, established_year の NULL 許容）
-- =============================================================================
...
CREATE TABLE public.facilities (
    ...
    phone TEXT,  -- NULL許容（施設担当者が後から入力可能）
    prefecture TEXT NOT NULL,
    city TEXT NOT NULL,
    address_detail TEXT NOT NULL,
    established_year INTEGER CHECK (established_year IS NULL OR established_year BETWEEN 1800 AND date_part('year', now())),
...
-- UPDATE/DELETE ポリシーは facility_profiles テーブル作成後に追加
-- （004_create_facility_relationships.sql で追加）
