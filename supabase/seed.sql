...
VALUES
  ...
  (
    ...
    '志筑1542-1 ',
    1955,
    '[{"name":"あすなろ","type":"地域小規模児童養護施設"},{"name":"まほろば","type":"地域小規模児童養護施設"}]'
  ),
  (
    12,
    '善照学園',
  ...
  (
    ...
    '管生澗673-1',
    1951,
    '[{"name":"すごう保育園","type":"幼保連携型認定こども園"},{"name":"姫路東こども園","type":"幼保連携型認定こども園"},{"name":"第二姫路東こども園","type":"幼保連携型認定こども園"}]'
  ),
  (
    17,
    '睦の家',
    ...
    '文室204-2',
    2013,
    '[{"name":"くれよん","type":"乳児院"},{"name":"リボン","type":"児童家庭支援センター"},{"name":"まんまる","type":"里親支援センター"}]'
  ),
  (
    18,
    '立正学園',
    ...
    '野村617-4',
    1956,
    '[{"name":"虹の丘","type":"児童家庭支援センター"},{"name":"さつき子どもホーム","type":"地域小規模"}]'
  ),
  (
    19,
    '若草寮',
  ...
  (
    ...
    '泉通4-4-5',
    1948,
    '[{"name":"和愛","type":"分園型小規模グループホーム"},{"name":"友愛","type":"分園型小規模グループホーム"}]'
  ),
  (
    22,
    '愛信学園',
