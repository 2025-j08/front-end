...
## 8. コードレビュー・回答時のフォーマット

コードレビューや改善提案を行う際は、重要度を可視化するために以下の **GitHub Alerts** 記法を使用してください。

- **重大な指摘 (Critical)**: バグ、セキュリティリスク、禁止事項違反

  > [!IMPORTANT]
  > **修正必須**: ここに理由を記述

- **警告 (Warning)**: 非推奨な実装、パフォーマンス懸念、副作用の可能性

  > [!WARNING]
  > **注意**: ここに理由を記述

- **推奨・提案 (Suggestion)**: リファクタリング、ベストプラクティス、可読性向上
  > [!TIP]
  > **改善提案**: ここにアイデアを記述
